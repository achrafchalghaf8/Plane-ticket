...
export class ListeDestinationComponent implements OnInit {
  ...
  filterDestinations() {
    ...
    const terms = query.split(/\s+/); // sépare par les espaces multiples
    ...
    this.filteredDestinations = this.destinations.filter(destination => {
      ...
      return terms.every(term => destinationString.includes(term));
    });
  }
  ...
  exportToPdf(): void {
    this.pdfExportService.exportDestinationList(this.filteredDestinations, 'Liste des Destinations');
  }
}
